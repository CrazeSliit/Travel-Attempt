import SriLankaTours from "@/app/components/experiences/sriLankaTours"
      ...
      <div className="container mx-auto px-4 pt-32 pb-20">
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Discover the pearl of the Indian Ocean with ancient temples, pristine beaches, and incredible biodiversity.
          </p>
        </div>
        <SriLankaTours />
