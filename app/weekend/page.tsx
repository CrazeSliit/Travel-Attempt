import WeekendGetaways from "@/app/components/travelPlans/weekendGetaways"
      ...
      <div className="container mx-auto px-4 pt-32 pb-20">
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Two to three day escapes combining relaxation with cultural discoveries across beautiful Sri Lanka.
          </p>
        </div>
        <WeekendGetaways />
